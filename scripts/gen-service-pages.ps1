...
# nav-active key per page -> set aria-current on /services/
$pages = @(
  @{
    slug='visa'; navkey='nav.visa';
    title='خدمات التأشيرة'; eyebrow='Assistance Visa';
    todo=$true;
    intro='نساعدك في تحضير ملف التأشيرة وترتيب الوثائق المطلوبة لوجهتك. نرافقك في الخطوات بصدق ووضوح، دون أن نَعِدك بما لا نملكه — قرار منح التأشيرة يبقى بيد القنصلية.';
    helpHead='بِمَ نساعدك';
    help=@(
      @{t='تأشيرة شنغن'; d='ترتيب وثائق ملف شنغن للسفر إلى أوروبا، ومراجعتها قبل التقديم.'},
      @{t='تأشيرة السعودية'; d='مرافقة في إجراءات تأشيرة العمرة والزيارة إلى السعودية.'},
      @{t='تأشيرة تركيا'; d='المساعدة في طلب التأشيرة الإلكترونية أو الورقية لتركيا.'},
      @{t='وجهات أخرى'; d='أذربيجان، ماليزيا وغيرها — تواصل معنا لنرى ما نستطيع ترتيبه لك.'}
    );
    stepsHead='كيف نعمل معك';
    steps=@(
      'تواصل معنا عبر واتساب وأخبرنا بوجهتك وتاريخ سفرك المتوقع.',
      'نوضّح لك قائمة الوثائق المطلوبة ونساعدك في تجهيزها وترتيبها.',
      'نرافقك حتى تقديم الملف، ونبقى معك للإجابة عن أسئلتك.'
    );
    note='ملاحظة بصدق: هذه الخدمة قيد التطوير، ولا نضمن الحصول على التأشيرة — نساعدك فقط في تحضير ملف سليم ومرتّب. (TODO-CLIENT: تأكيد نطاق الخدمة والوجهات المدعومة)';
    waEnc='%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%20%D8%A3%D8%B1%D9%8A%D8%AF%20%D8%A7%D9%84%D8%A7%D8%B3%D8%AA%D9%81%D8%B3%D8%A7%D8%B1%20%D8%B9%D9%86%20%D8%AE%D8%AF%D9%85%D8%A7%D8%AA%20%D8%A7%D9%84%D8%AA%D8%A3%D8%B4%D9%8A%D8%B1%D8%A9';
  },
  @{
    slug='hotellerie'; navkey='nav.hotellerie';
    title='حجز الفنادق'; eyebrow='Hôtellerie';
    todo=$false;
    intro='نحجز لك الغرفة المناسبة في أي وجهة — داخل الجزائر أو خارجها — بأسعار تفاوضنا عليها لك. تصلك التفاصيل والتأكيد عبر واتساب دون عناء البحث والمقارنة.';
    helpHead='ماذا نحجز لك';
    help=@(
      @{t='فنادق متعددة الوجهات'; d='تونس، تركيا، أذربيجان، ماليزيا، مصر، السعودية وغيرها.'},
      @{t='قرب من الحرم'; d='فنادق على مسافات مختلفة من الحرم للعمرة والحج، حسب ميزانيتك.'},
      @{t='غرف عائلية وفردية'; d='نختار لك الغرفة التي تناسب عدد المسافرين ونوع الإقامة.'},
      @{t='أنواع إقامة'; d='إقامة كاملة أو نصف إقامة أو مع الفطور — كما يناسبك.'}
    );
    stepsHead='كيف تحجز معنا';
    steps=@(
      'أخبرنا بالوجهة والتواريخ وعدد المسافرين عبر واتساب.',
      'نقترح عليك خيارات فنادق بأسعار واضحة.',
      'تختار، ونؤكد الحجز ونرسل لك التفاصيل.'
    );
    note='';
    waEnc='%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%20%D8%A3%D8%B1%D9%8A%D8%AF%20%D8%AD%D8%AC%D8%B2%20%D9%81%D9%86%D8%AF%D9%82';
  },
  @{
    slug='vols'; navkey='nav.vols';
    title='حجز التذاكر'; eyebrow='Billetterie / Vols';
    todo=$false;
    intro='نقارن لك بين شركات الطيران ونجد أفضل سعر لرحلتك، انطلاقًا من مطار قسنطينة أو غيره. تذاكر مؤكدة وأسعار شفافة دون مفاجآت ولا رسوم خفية.';
    helpHead='ماذا نوفّر لك';
    help=@(
      @{t='مقارنة بين الشركات'; d='نبحث في عدة شركات طيران لنجد أنسب سعر وأفضل توقيت.'},
      @{t='انطلاق من قسنطينة'; d='أولوية للرحلات المباشرة من مطار قسنطينة قُربًا منك.'},
      @{t='ذهاب وإياب أو ذهاب فقط'; d='نرتّب لك التذكرة حسب حاجتك ومرونة تواريخك.'},
      @{t='تأكيد سريع'; d='نؤكد الحجز ونرسل لك التذكرة فور إتمام الدفع.'}
    );
    stepsHead='كيف نحجز تذكرتك';
    steps=@(
      'أرسل لنا الوجهة والتواريخ وعدد المسافرين عبر واتساب.',
      'نعرض عليك أفضل الأسعار المتاحة من عدة شركات.',
      'تختار، وندفع ونؤكد ونرسل لك التذكرة.'
    );
    note='';
    waEnc='%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%20%D8%A3%D8%B1%D9%8A%D8%AF%20%D8%AD%D8%AC%D8%B2%20%D8%AA%D8%B0%D9%83%D8%B1%D8%A9%20%D8%B7%D9%8A%D8%B1%D8%A7%D9%86';
  }
)

foreach($p in $pages){
  # build help cards
  $helpCards = ($p.help | ForEach-Object {
    "          <article class=`"service-card`"><h3>$($_.t)</h3><p>$($_.d)</p></article>"
  }) -join "`n"

  # build steps list
  $stepsList = ($p.steps | ForEach-Object {
    "          <li style=`"display:flex;gap:.6rem;align-items:start`"><svg width=`"22`" height=`"22`" viewBox=`"0 0 24 24`" fill=`"none`" stroke=`"var(--color-primary)`" stroke-width=`"2`" stroke-linecap=`"round`" stroke-linejoin=`"round`" style=`"flex:none`" aria-hidden=`"true`"><polyline points=`"20 6 9 17 4 12`"/></svg> $_</li>"
  }) -join "`n"

  $todoChip = if($p.todo){ ' <span class="n-chip" style="background:var(--color-accent-soft);color:var(--color-accent-strong)">قيد التأكيد — TODO-CLIENT</span>' } else { '' }
  $noteBlock = if($p.note){ "        <p class=`"hotel`" style=`"margin-block-start:var(--space-4);color:var(--text-muted);max-width:60ch`">$($p.note)</p>" } else { '' }
...
<body data-mode="rihla">
  ...
  <nav class="site-nav" aria-label="التنقّل الرئيسي">
    ...
    <div class="nav-links">
      ...
      <a href="/voyages/" data-i18n="nav.voyages">الرحلات المنظمة</a>
      <a href="/services/" data-i18n="nav.services" aria-current="page">الخدمات</a>
  ...
  <main id="main">
    ...
    <section class="section" style="padding-block-start:calc(var(--nav-h) + var(--space-7))" id="intro">
      <div class="wrap">
        <div class="sec-head">
          <span class="eyebrow">$($p.eyebrow)</span>
          <h1 style="font-size:var(--text-3xl)">$($p.title)$todoChip</h1>
          <p>$($p.intro)</p>
        </div>
        <div class="cta-row" style="display:flex;gap:var(--space-3);flex-wrap:wrap">
          <a class="n-btn n-btn-wa" href="https://wa.me/213661457025?text=$($p.waEnc)" target="_blank" rel="noopener" data-i18n="cta.whatsapp">تواصل واتساب</a>
          <a class="n-btn n-btn-ghost" href="tel:+213661457025"><span dir="ltr">0661 45 70 25</span></a>
        </div>
$noteBlock
      </div>
    </section>

    <section class="section" id="what-we-help" style="background:var(--surface-raised)">
      <div class="wrap">
        <div class="sec-head">
          <h2>$($p.helpHead)</h2>
        </div>
...
$helpCards
    ...
    <section class="section" id="steps">
      <div class="wrap">
        ...
        <ul style="display:grid;gap:var(--space-3);max-width:56ch">
$stepsList
        </ul>
        <div class="cta-row" style="display:flex;gap:var(--space-3);margin-block-start:var(--space-6);flex-wrap:wrap">
          <a class="n-btn n-btn-accent" href="https://wa.me/213661457025?text=$($p.waEnc)" target="_blank" rel="noopener" data-i18n="cta.whatsapp">ابدأ عبر واتساب</a>
        </div>
      </div>
    </section>
...
"@
  ...
  $dir = Join-Path $root "site/services/$($p.slug)"
