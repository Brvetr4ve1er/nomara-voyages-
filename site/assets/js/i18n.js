...
(function () {
  ...
  var STATIC_TEXT_FR = {
    ...
    'هذه نماذج توضيحية لشكل المراجعات — لا نعرض مراجعات حقيقية إلا بعد موافقة أصحابها.': 'Ces avis sont des exemples de mise en page. Les vrais avis ne seront publiés qu’avec l’accord de leurs auteurs.',
    ...
    'ملاحظة بصدق: هذه الخدمة قيد التطوير، ولا نضمن الحصول على التأشيرة — نساعدك فقط في تحضير ملف سليم ومرتّب.': 'Note honnête : ce service est en développement. Nous ne garantissons pas l’obtention du visa ; nous aidons à préparer un dossier clair et complet.',
